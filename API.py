...
class PetFriends:
    ...
    def get_api_key(self, email: str, password: str) -> json:
        ...
        с уникалиным ключем пользователя, найденного по указанным email и паролем"""
    ...
    def get_list_of_pets(self, auth_key: json, filter: str = "") -> json:
        ...
        либо пустое значение - получать список всех питомцев, либо 'my_pets' - получить список
